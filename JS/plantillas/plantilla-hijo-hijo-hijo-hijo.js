...
function setHeaderTemplate(){
    header.innerHTML = `
        ...
        <section class="sectC3H">
            ...
            <nav class="contLinksC3H">
                <ul class="listLinkC3H">
                    ...
                    <a href="../../../../views/gestion-escolar/gestion-escolar.html" class="aElement linkHC3" id="gestion-escolar">
                        <li class="itemListC3H">
                        <b><p class="textItemListC3H">Gestión escolar</p></b>
                        </li>
                    </a>
                    ...
                    <a href="../../../../views/investigacion/investigacion.html" class="aElement linkHC3" id="investigacion">
                        <li class="itemListC3H">
                    ...
                    <a href="../../../../views/gestion-de-calidad/gestion-de-calidad.html" class="aElement linkHC3" id="gestion-de-calidad">
                        <li class="itemListC3H">
                            <b><p class="textItemListC3H">Gestión de calidad</p></b>
                        </li>
                    </a>
        ...
        <section class="menusC3H">
            ...
            <section class="sectMenuIndividual sectMI-I menuServicesH">
                <nav class="navMenuI">
                    <ul class="listMenuIndividual">
                        <a href="../../../../views/servicios/biblioteca.html" class="aElement linkHC3" id="biblioteca">
                            <li class="itemListMI">
                            <img src="../../../../img/logoC3.png" alt="" class="imgItemListMI">
                            <p class="textItemListMI">Biblioteca</p>
                            </li>
                        </a>
                        ...
                        <a href="https://celex.cecyt3.ipn.mx/" class="aElement linkHC3" id="celex">
                            <li class="itemListMI">
                            <img src="../../../../img/logoC3.png" alt="" class="imgItemListMI">
                            <p class="textItemListMI">CELEX</p>
                            </li>
                        </a>
                        <a href="../../../../views/servicios/servicio-medico.html" class="aElement linkHC3" id="servicio-medico">
                            <li class="itemListMI">
                            <img src="../../../../img/logoC3.png" alt="" class="imgItemListMI">
                            <p class="textItemListMI">Servicio Médico</p>
                            </li>
                        </a>
                        ...
                        <a href="../../../../views/servicios/poliemprende.html" class="aElement linkHC3" id="poliemprende">
                            <li class="itemListMI">
                            <img src="../../../../img/logoC3.png" alt="" class="imgItemListMI">
                            <p class="textItemListMI">POLIEMPRENDE</p>
                            </li>
                        </a>
                ...
                <nav class="navMenuC3H-RES mC3H">
                    <ul class="listMenuC3H-RES mC3H">
                        ...
                        <a href="../../../../views/gestion-escolar/gestion-escolar.html" class="aElement linkHC3" id="gestion-escolar">
                            <li class="itemMenuC3H-RES mC3H">
                                <img src="../../../../img/imgMenuR.png" alt="" class="imgItemMC3H-RES mC3H">
                                <p class="textMenuC3H-RES mC3H">Gestion escolar</p>
                            </li>
                        </a>
                        ...
                        <a href="../../../../views/investigacion/investigacion.html" class="aElement mC3H linkHC3" id="investigacion">
                            <li class="itemMenuC3H-RES mC3H">
                                <img src="../../../../img/imgMenuR.png" alt="" class="imgItemMC3H-RES mC3H">
                        ...
                        <li class="itemSubMenuC3H-RES itemSMC3H-RES-I mC3H">
                            ...
                            <nav class="navItemSubMC3H-RES mC3H">
                                <ul class="listItemSMC3H-RES mC3H">
                                    <a href="../../../../views/servicios/biblioteca.html" class="aElement mC3H linkHC3" id="biblioteca">
                                        <li class="itemListISMC3H-RES mC3H">
                                            <img src="../../../../img/imgMenuR.png" alt="" class="imgItemMC3H-RES mC3H">
                                            <p class="textMenuC3H-RES mC3H">Biblioteca</p>
                                        </li>
                                    </a>
                                    ...
                                    <a href="https://celex.cecyt3.ipn.mx/" class="aElement mC3H linkHC3" id="celex">
                                        <li class="itemListISMC3H-RES mC3H">
                                            <img src="../../../../img/imgMenuR.png" alt="" class="imgItemMC3H-RES mC3H">
                                            <p class="textMenuC3H-RES mC3H">CELEX</p>
                                        </li>
                                    </a>
                                    <a href="../../../../views/servicios/servicio-medico.html" class="aElement mC3H linkHC3" id="servicio-medico">
                                        <li class="itemListISMC3H-RES mC3H">
                                            <img src="../../../../img/imgMenuR.png" alt="" class="imgItemMC3H-RES mC3H">
                                            <p class="textMenuC3H-RES mC3H">Servicio Médico</p>
                                        </li>
                                    </a>
                                    ...
                                    <a href="../../../../views/servicios/poliemprende.html" class="aElement mC3H linkHC3" id="poliemprende">
                                        <li class="itemListISMC3H-RES mC3H">
                                            <img src="../../../../img/imgMenuR.png" alt="" class="imgItemMC3H-RES mC3H">
                                            <p class="textMenuC3H-RES mC3H">POLIEMPRENDE</p>
                                        </li>
                                    </a>
        ...
        <section class="sectLocation">
            <div class="contContactUs">
                <nav class="navContactUs">
                    <ul class="listContactUs">
                        <a href="https://www.facebook.com/cecyt3oficial" class="aElement">
                            <li class="itemListCU">
                                <img src="../../../../img/facebook.png" alt="" class="imgListCU">
                            </li>
                        </a>
                        <a href="https://www.instagram.com/cecyt_3/" class="aElement">
                            <li class="itemListCU">
                                <img src="../../../../img/instagram.png" alt="" class="imgListCU">
                            </li>
                        </a>
                        <a href="#" class="aElement">
                            <li class="itemListCU">
                                <img src="../../../../img/tiktok.png" alt="" class="imgListCU">
                            </li>
                        </a>
                        <a href="https://twitter.com/CECYT_3" class="aElement">
                            <li class="itemListCU">
                                <img src="../../../../img/twitter.png" alt="" class="imgListCU">
                            </li>
                        </a>
                        <a href="tel:55 5624 2000" class="aElement">
                            <li class="itemListCU">
                                <img src="../../../../img/telephone.png" alt="" class="imgListCU imgListCU-telephone">
                            </li>
                        </a>
                        <a href="mailto:upis.cecyt3@ipn.mx" class="aElement">
                            <li class="itemListCU">
            ...
            <article class="artLocation">
                <div class="contLocation">
                    ...
                    <div style="width: 100%"><iframe width="100%" height="500" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=500&amp;hl=es&amp;q=Cedro%20Manzana%20027,%20Sin%20Nombre,%2055119%20Ecatepec%20de%20Morelos,%20M%C3%A9x.+(Centro%20de%20Estudios%20Cient%C3%ADficos%20y%20Tecnol%C3%B3gicos%20N%C2%B0%203%20%E2%80%9CEstanislao%20Ram%C3%ADrez%20Ruiz%E2%80%9D%20IPN)&amp;t=h&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/car-satnav-gps/">Car GPS</a></iframe></div>
        ...
        <section class="sectEduPub">
            <article class="artEduPub">
                <div class="contInfoEP">
                    ...
                    <p class="textEP">
                        D.R. 2022 Instituto Politécnico Nacional (IPN) - CECyT 3. Av. Carlos Hank González s/n, Col. Valle de Ecatepec, Ecatepec de Morelos, Edo. de México, CP 55119, Tel. 56242000 ext 74004 cecyt3@ipn.mx
                        <br><br>
